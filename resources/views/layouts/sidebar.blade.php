...
<section class="sidebar">
    ...
    <div id="left_menu_to_scroll">
        <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
            ...
            @endif
            @if (menuPermission('liveLocation'))
                <li class="parent-menu treeview2 menu_assign_class menu__cidirp_1{{ request()->is('liveLocation') ? ' menu-open active_sub_menu' : '' }}"
                    data-menu__cid="irp_1">
                    <a href="{{ route('liveLocation') }}">
                        <iconify-icon icon="material-symbols:location-on-outline"></iconify-icon>
                        <span class="match_bold">LiveLocation</span>
                    </a>
                </li>
            @endif
            @if (menuPermission('Timeline'))
                <li class="parent-menu treeview2 menu_assign_class menu__cidirp_1{{ request()->is('timeLine') ? ' menu-open active_sub_menu' : '' }}"
                    data-menu__cid="irp_1">
            ...
            @endif
            @if (menuPermission('CardView'))
                <li class="parent-menu treeview2 menu_assign_class menu__cidirp_1{{ request()->is('cardView') ? ' menu-open active_sub_menu' : '' }}"
                    data-menu__cid="irp_1">
                    <a href="{{ route('cardView') }}">
            ...
            @if (menuPermission('Settings'))
                <li
                    class="parent-menu treeview menu__cidirp_10{{ request()->is('settings') || request()->is('white-label') || request()->is('taxes') || request()->is('units*') || request()->is('mail-settings') || request()->is('productionstages*') ? ' menu-open active_sub_menu' : '' }}">
                    <a href="#">
