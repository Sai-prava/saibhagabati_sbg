                    ...
                    <div class="col-sm-12 mb-2 col-md-6">
                        <div class="d-flex gap-2 align-items-center">
                            <div class="form-group w-50">
                                ...
                                <select class="form-control @error('order') is-invalid @enderror select2" name="order"
                                    id="order_id">
                                    <option value="">@lang('index.select_order')</option>
                                    @foreach ($orders as $value)
                                        <option value="{{ $value->id }}|{{ $value->reference_no }}">
                            ...
                            <tbody>
                                ...
                                @foreach ($obj as $value)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->name }}</td>
                                        <td>{{ $value->code }}</td>
                                        <td>{{ $value->current_total_stock ?? 0 }}</td>
