                                    ...
                                    <div class="w-100">
                                        <select class="form-control select2" id="customer_id" name="customer_id">
                                            ...
                                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <option data-credit_limit="<?php echo e($value->credit_limit); ?>"
                                                    data-current_due="<?php echo e($current_due); ?>"
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 check_required" id="status" name="status">
                                    <option value="Draft"
                                        <?php echo e(isset($obj->status) && $obj->status == 'Draft' ? ' selected' : ''); ?>>Draft
                                    </option>
                                    <option value="Final"
                                        <?php echo e(isset($obj->status) && $obj->status == 'Final' ? ' selected' : ''); ?>>Final
                                    </option>
                                </select>
                                <div class="text-danger d-none"></div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" name="product_id"
                                    ...
                                    <?php $__currentLoopData = $finishProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($fp->id . '|' . $fp->name . ' (' . $fp->code . ')|' . $fp->name . '|' . productSalePrice($fp->id) . '|' . getPurchaseSaleUnitById($fp->unit) . '|' . $setting->currency . '|' . $fp->stock_method . '|' . $fp->current_total_stock); ?>"><?php echo e($fp->name . '(' . $fp->code . ')'); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <div class="text-danger d-none"></div>
                            </div>
                                            ...
                                            <?php $__currentLoopData = $sale_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr class="rowCount" data-id="<?php echo e($value->product_id); ?>">
                                                    ...
                                                    <td><input type="hidden" value="<?php echo e($value->product_id); ?>"
                                                        ...
                                                        <?php if($manufactureInfo && $manufactureInfo->expiry_days !== null && $manufactureInfo->complete_date !== null && $manufactureInfo->expiry_days !== 0): ?>
                                                            <br><small>Expiry Date: <?php echo e(getDateFormat(expireDate($manufactureInfo->complete_date, $manufactureInfo->expiry_days))); ?></small>
                                                        <?php endif; ?>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="number" id="total_1" name="total[]"
                                                                ...
                                                                value="<?php echo e($value->total_amount); ?>" placeholder="Total"
                                                                readonly="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sbg_product\resources\views/pages/sales/addEditSale.blade.php ENDPATH**/ ?>