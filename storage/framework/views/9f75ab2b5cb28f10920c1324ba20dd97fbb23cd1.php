...
<?php $__env->startSection('content'); ?>
    ...
    <section class="main-content-wrapper">
        ...
        <div class="box-wrapper">
            <form action="<?php echo e(route('data-import.import')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
...
unset($__errorArgs, $__bag); ?> select2" name="type"
                                    id="type">
                                    <option value=""><?php echo app('translator')->get('index.select_type'); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mt-1">
                                <label for="import_file"><?php echo app('translator')->get('index.import_file'); ?> <span class="required_star">*</span>
                                    (<?php echo app('translator')->get('index.xls_xlsx'); ?>)</label>
                                <input type="file" class="form-control <?php $__errorArgs = ['import_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button type="submit" class="btn bg-blue-btn mt-4"><iconify-icon
                                    icon="solar:check-circle-broken"></iconify-icon><?php echo app('translator')->get('index.import'); ?></button>
                        </div>
                    </div>
                <div class="col-12">
                    <div class="form-group">
                        <label for="sample_file"><?php echo app('translator')->get('index.download_sample_file'); ?></label>
                        <a href="<?php echo e(route('data-import.sample')); ?>" target="_blank">
                            <iconify-icon icon="solar:download"></iconify-icon><?php echo app('translator')->get('index.download_sample'); ?>
                        </a>
                    </div>
                </div>
                </div>                
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sbg_product\resources\views/pages/data-import/index.blade.php ENDPATH**/ ?>