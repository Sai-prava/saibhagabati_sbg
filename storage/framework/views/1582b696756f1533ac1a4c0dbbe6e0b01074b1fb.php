            ...
            <div class="col-6">
                <div class="float-start">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-outline-primary">All <span class="badge bg-secondary"
                                name="all">0</span>
                        </button>
                        ...
                        <button id="nw" name="nw" type="button" class="btn btn-outline-primary">Not working
                            <span class="badge bg-info">0</span></button>
                    </div>
                </div>
            </div>
                ...
                <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card mt-2">
                        <div class="card-header bg-light">
                            <h6 class="card-title mb-0"><?php echo e($team['name']); ?> <span class="text-muted">(Total Employees:
                                    <?php echo e($team['totalEmployees']); ?>)</span>
                            </h6>
                        </div>
                        <div class="card-body">
                            <?php if(!$team['cardItems']): ?>
                                <p>No checkins!</p>
                            <?php else: ?>
                                <?php $__currentLoopData = $team['cardItems']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cardItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        class="col-xxl-6 col-xl-6 col-lg-6 col-sm-12 d-flex align-items-stretch flex-column">
                                        <div class="card radius-10 mb-3 shadow-lg" id="<?php echo e($cardItem['id'] . 'card'); ?>">
                                            <div class="card-body">
                                                <div id="@(user.Id+nameof(user.IsOnline))"
                                                    ...
                                                    <div class="d-flex align-items-center gap-3 ms-2 flex-shrink-0">
                                                        ...
                                                        <div class="profile-info">
                                                            <h3 class="mb-1 fs-1 profile-name"><?php echo e($cardItem['name']); ?></h3>
                                                            <p class="mb-0 profile-number">
                                                                <?php echo e($settings->phone_country_code); ?>

                                                                -<?php echo e($cardItem['phoneNumber']); ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="hstack gap-2 fs-2 align-self-start ms-2 ms-lg-0">
                                                        <div id="<?php echo e($cardItem['id'] . 'IsWifiOn'); ?>">
                                                        ...
                                                        <div class="d-flex gap-2 align-items-center"
                                                            id="<?php echo e($cardItem['id'] . 'BatteryLevel'); ?>">
                                                            <div class="placeholder-glow">
                                                                <span class="placeholder" style="width:25px;"></span>
                                                            </div>
                                                        </div>
                                                        <div class="vr"></div>
                                                        <div id="<?php echo e($cardItem['id'] . 'IsGpsOn'); ?>">
                                                            <div class="placeholder-glow">
                                                                <span class="placeholder" style="width:25px;"></span>
                                                            </div>
                                                        </div>
                                                ...
                                                <ul class="list-group mt-4 radius-10">
                                                    <li class="list-group-item list-group-item-primary fs-01">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <p class="mb-0 text-primary">Attendance:
                                                                IN <?php echo e($cardItem['attendanceInAt']); ?></p>
                                                            <a href="<?php echo e(route('timeLine')); ?>" class="mb-0"><span
                                                    ...
                                                    <li class="list-group-item fs-01">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div class="text-dark text-end"
                                                                id="<?php echo e($cardItem['id'] . 'location'); ?>">
                                                                <div class="placeholder-glow">
                                                    ...
                                                    <li class="list-group-item fs-01">
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <div class="text-dark text-end"
                                                                id="<?php echo e($cardItem['id'] . 'UpdatedAt'); ?>">
                                                                <div class="placeholder-glow">
                                                                    <span class="placeholder" style="width:75px;"></span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="collapse" id="collapseExample">
                                                            <div
                                                                ...
                                                                <p><strong>Team : </strong> <?php echo e($team['name']); ?></p>
                                                                <p><strong>Today's
                                                                        visits: <?php echo e($cardItem['visitsCount']); ?></strong></p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
        ...
        <script>
            ...
            function setInfo(userId, attIn, attOut, lat, lon) {
                ...
                if (attIn.length === 0 && attOut.length === 0) {
                    content +=
                        ` <li class="small"><span class="fa-li"><i class="fas fa-window-close"></i></span> <b>Not checked in!</b></li>`;
                }

                if (attIn.length !== 0) {
                    content +=
                        `<li class="small"><span class="fa-li"><i class="fas fa-sign-in-alt"></i></span> <b>AttendanceIn:</b> ${attIn}</li>`
                }

                if (attOut.length !== 0) {
                    content +=
                        ` <li class="small" ><span class="fa-li"><i class="fas fa-sign-out-alt"></i></span> <b>AttendanceOut:</b> ${attOut}</li>`;
                }
            ...
            function getReverseGeocodingData(lat, lng, id) {
                ...
                geocoder.geocode({
                    ...
                    if (status == google.maps.GeocoderStatus.OK) {
                        ...
                        address +=
                            `<span class="fa-li"><i class="fas fa-location-arrow"></i></span> <b>Last location: ${address}</b> `;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saibhagabati\resources\views/pages/card_view.blade.php ENDPATH**/ ?>